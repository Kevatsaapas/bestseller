			...
			for (Kilpailija kilpailija : kaikkikilpailijat) {
				...
				if (arvioinnit.size() > 0) {
					for (Arviointi arviointi : arvioinnit) {
						...
						kysymystenKasittely1.add(
								Integer.parseInt(arviointi.getKysymystenKasittely().getHuolenaiheidenKasittelyPist()));
						kysymystenKasittely2.add(Integer
								.parseInt(arviointi.getKysymystenKasittely().getVastavaitteidenYmmartaminenPist()));
						...
						tarvekartoitus2
								.add(Integer.parseInt(arviointi.getTarvekartoitus().getPaatoksentekoprosessiPist()));
						tarvekartoitus3
								.add(Integer.parseInt(arviointi.getTarvekartoitus().getPerustietojenSelvitysPist()));
						tarvekartoitus4
								.add(Integer.parseInt(arviointi.getTarvekartoitus().getTarpeenKehittaminenPist()));
						yleisvaikutelma1
								.add(Integer.parseInt(arviointi.getYleisvaikutelma().getAktiivinenKuunteluPist()));
						yleisvaikutelma2.add(Integer.parseInt(arviointi.getYleisvaikutelma().getTilannetajuPist()));
						yleisvaikutelma3
								.add(Integer.parseInt(arviointi.getYleisvaikutelma().getOmaKayttaytyminenPist()));
					}
					...
					kokonaistulos = (aloitus * 0.05) + (tarvekartoitus * 0.3) + (ratkaisu * 0.25)
					...
					// "+(kilpailija.getEtunimi()+" "+kilpailija.getSukunimi())+" lohko:
					// "+kilpailija.getLohko().getLohkoNro()+" kokonaistulos: "+kokonaistulos);
					arvioinnit.clear();
				...
				aloitusKa3 = 0;
				aloitus = 0;
				kysymystenKasittely1.clear();
				kysymystenKasittely2.clear();
				kysymystenKasittelyKa1 = 0;
				kysymystenKasittelyKa2 = 0;
				kysymystenKasittely = 0;
				paattaminen1.clear();
				paattaminen2.clear();
				paattaminenKa1 = 0;
				paattaminenKa2 = 0;
				...
				ratkaisuKa3 = 0;
				ratkaisu = 0;
				tarvekartoitus1.clear();
				tarvekartoitus2.clear();
				tarvekartoitus3.clear();
				tarvekartoitus4.clear();
				tarvekartoitusKa1 = 0;
				tarvekartoitusKa2 = 0;
				tarvekartoitusKa3 = 0;
				tarvekartoitusKa4 = 0;
				tarvekartoitus = 0;
				yleisvaikutelma1.clear();
				yleisvaikutelma2.clear();
				yleisvaikutelma3.clear();
				yleisvaikutelmaKa1 = 0;
				yleisvaikutelmaKa2 = 0;
				yleisvaikutelmaKa3 = 0;
				yleisvaikutelma = 0;
				kokonaistulos = 0;
				ostajanArviot.clear();
				ostajanArvioKa = 0;
		...
		for (Kilpailija kilpailija : kaikkikilpailijat) {
			...
			if (arvioinnit.size() > 0) {
				for (Arviointi arviointi : arvioinnit) {
					...
					aloitus2.add(Integer.parseInt(arviointi.getAloitus().getTapaamisenAjankayttoPist()));
					aloitus3.add(Integer.parseInt(arviointi.getAloitus().getTapaamisenLahtotilannePist()));
					kysymystenKasittely1
							.add(Integer.parseInt(arviointi.getKysymystenKasittely().getHuolenaiheidenKasittelyPist()));
					kysymystenKasittely2.add(
							Integer.parseInt(arviointi.getKysymystenKasittely().getVastavaitteidenYmmartaminenPist()));
					paattaminen1.add(Integer.parseInt(arviointi.getPaattaminen().getSitoutumisenEhdotusPist()));
					paattaminen2.add(Integer.parseInt(arviointi.getPaattaminen().getSitoutumisenSaaminenPist()));
					ratkaisu1.add(Integer.parseInt(arviointi.getRatkaisu().getHaasteYhteenvetoPist()));
					ratkaisu2.add(Integer.parseInt(arviointi.getRatkaisu().getHyotyjenEsilletuontiPist()));
