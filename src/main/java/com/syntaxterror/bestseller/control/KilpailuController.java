...
public class KilpailuController {
    ...
    private void luoLohkot(Long kilpailuId) {
        ...
        System.out.println(loh);
        kilpailuRepository.save(kilpailu);
        Koulu koulu1 = new Koulu("Haaga-Helia", "Helsinki", kilpailuId);
        Koulu koulu2 = new Koulu("Turku AMK", "Turku", kilpailuId);
        Koulu koulu3 = new Koulu("Tampereen AMK", "Tampere", kilpailuId);
        Koulu koulu4 = new Koulu("Laurea AMK", "Vantaa", kilpailuId);
        Koulu koulu5 = new Koulu("Jyväskylä AMK", "Jyväskylä", kilpailuId);
        Koulu koulu6 = new Koulu("Kaakkois-Suomen AMK", "Mikkeli", kilpailuId);
        Koulu koulu7 = new Koulu("Metropolia AMK", "Helsinki", kilpailuId);
        kouluRepository.save(koulu1);
        kouluRepository.save(koulu2);
        kouluRepository.save(koulu3);
        kouluRepository.save(koulu4);
        kouluRepository.save(koulu5);
        kouluRepository.save(koulu6);
        kouluRepository.save(koulu7);
    }
