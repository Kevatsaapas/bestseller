...
public class OstajaArviointi {
    ...
    public OstajaArviointi(Date arviointiPvm, Kilpailija kilpailija, Ostaja ostaja, Lohko lohko, Long kilpailuId, Long ostajanArvio) {
    ...
    public String toString() {
        return "OstajaArviointi{" +
                "ostajaArviointiId=" + ostajaArviointiId +
                ", arviointiPvm=" + arviointiPvm +
                ", kilpailija=" + kilpailija +
                ", ostaja=" + ostaja +
                ", lohko=" + lohko +
                ", kilpailuId=" + kilpailuId +
                ", ostajanArvio=" + ostajanArvio +
                '}';
    }
