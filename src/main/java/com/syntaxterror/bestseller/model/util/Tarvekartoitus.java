...
public class Tarvekartoitus {
	...
	public int getKokonaistulos() {
		return Integer.parseInt(perustietojenSelvitysPist) + Integer.parseInt(asiakkaanNykytilaPist)
				+ Integer.parseInt(tarpeenKehittaminenPist) + Integer.parseInt(paatoksentekoprosessiPist);
	}
}
